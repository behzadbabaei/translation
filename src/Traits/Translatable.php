...
namespace Behzadbabaei\Translation\Traits;
...
trait Translatable
{
    ...
    /**
     *  Hijack Eloquent's setAttribute to create a Language Entry, or update the existing one, when setting the value
     *  of this attribute.
     *
    ...
    /**
     *  Extend parent's attributesToArray so that _translation attributes do not appear in array, and translatable
