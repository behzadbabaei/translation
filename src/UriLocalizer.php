...
class UriLocalizer
{
    ...
    private string|array $availableLocales;
     ...
     *  Ex: /home => /es/home, /en/home => /es/home, http://www.domain.com/en/home => /en/home, https:://domain.com/ =>
     *  /en If a non zero segment index is given, and the url doesn't have enought segments, the url is unchanged.
     *
     * @param string  $url
     * @param string  $locale
     * @param integer $segment Index of the segment containing locale info
     ...
     *  Ex: http://www.domain.com/locale/random => /random, https://www.domain.com/random => /random,
     *  http://domain.com/random?param=value => /random?param=value
     *
     * @param string  $url
     * @param integer $segment Index of the segment containing locale info
     *
     ...
     *      A new "segments" key replaces 'path', with the uri segments in array form ('/es/random/thing' => ['es',
     *      'random', 'thing']) A 'locale' key is added, with the value of the locale found in the current url
     *
     * @param string  $url
     * @param integer $segment Index of the segment containing locale info
     *
