...
namespace Behzadbabaei\Translation\Test\Commands;
...
class FlushTest extends TestCase
{
    ...
    public function it_does_nothing_if_cache_disabled()
    {
        ...
        $command = Mockery::mock('Behzadbabaei\Translation\Commands\CacheFlushCommand[info]', [$this->cacheRepository, false]);
    ...
    public function it_flushes_the_cache()
    {
        $this->cacheRepository->put('en', 'group', 'namespace', 'value', 60);
        $this->assertTrue($this->cacheRepository->has('en', 'group', 'namespace'));
        $command = Mockery::mock('Behzadbabaei\Translation\Commands\CacheFlushCommand[info]', [$this->cacheRepository, true]);
